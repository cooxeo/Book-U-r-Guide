  ...
  return (
    ...
    <div className='mt-8'>
        ...
        <div className='mt-8 flex flex-col gap-y-4'>
            <button className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-orange-700 rounded-xl text-white font-bold text-lg'>Sign in</button>
            <button 
    ...
    <div className='hidden lg:flex h-[760px] w-full object-cover my-2 px-28'>
        <img className='rounded-lg' src="https://images.pexels.com/photos/10718781/pexels-photo-10718781.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="image" />
    </div>
    </div>
